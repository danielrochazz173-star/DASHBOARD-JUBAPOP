...
- Indicadores principais (total, idade media, dia mais votado e area mais citada)
- Graficos de dias preferidos e areas de servico
- Filtro por area e lista de pessoas
...
2. Clique em "Atualizar agora" para buscar os dados.

## Observacoes

- O arquivo app.js faz a leitura dos dados e monta o dashboard.
- O arquivo styles.css define o visual do layout.
